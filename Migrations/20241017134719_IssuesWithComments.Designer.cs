...
namespace sip.Migrations
{
    ...
    [Migration("20241017134719_IssuesWithComments")]
    partial class IssuesWithComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sip.Experiments.Model.ExperimentDataSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<TimeSpan?>("CleanAfter")
                        .HasColumnType("interval");

                    b.Property<DateTime?>("DtCleaned")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("ExperimentDataSource");
                });
            ...
            modelBuilder.Entity("sip.Experiments.Model.ExperimentPublication", b =>
                {
                    ...
                    b.Property<TimeSpan>("EmbargoPeriod")
                        .HasColumnType("interval");
            ...
            modelBuilder.Entity("sip.LabIssues.IssueComment", b =>
                {
                    b.Property<Guid>("_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("IssueOrganizationId")
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("IssueOrganizationId", "IssueId");
            ...
            modelBuilder.Entity("sip.Experiments.Model.ExperimentDataSource", b =>
                {
                    b.HasOne("sip.Experiments.Model.Experiment", "Experiment")
                        .WithOne("DataSource")
                        .HasForeignKey("sip.Experiments.Model.ExperimentDataSource", "ExperimentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("sip.LabIssues.IssueComment", b =>
                {
                    b.HasOne("sip.Userman.AppUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId");

                    b.HasOne("sip.LabIssues.Issue", "Issue")
                        .WithMany("IssueComments")
                        .HasForeignKey("IssueOrganizationId", "IssueId");
